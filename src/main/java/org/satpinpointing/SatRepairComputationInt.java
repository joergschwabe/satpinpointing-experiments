 ...
 */
public class SatRepairComputationInt<C, I extends Inference<? extends C>, A> extends MinimalSubsetsFromProofs<C, I, A> {

	private static final SatRepairComputationInt.Factory<?, ?, ?> FACTORY_ = new Factory<Object, Inference<?>, Object>();
	...
	private SatRepairComputationInt(final Proof<? extends I> proof,
	...
	private class Enumerator implements MinimalSubsetEnumerator<A> {
		...
		public void enumerate(Listener<A> listener) {
			...
			try {
				...
				FindingAndAddRepairs_IntProof<I, A> findingAndAddRepairs = new FindingAndAddRepairs_IntProof<I, A>(listener, query);
	...
	private static class Factory<C, I extends Inference<? extends C>, A>
		...
		public MinimalSubsetEnumerator.Factory<C, A> create(final Proof<? extends I> proof,
			...
			return new SatRepairComputationInt<C, I, A>(proof, justifier, monitor);
		}
