 ...
 */
public class SatRepairComputationSat4j_best17<C, I extends Inference<? extends C>, A>
		extends MinimalSubsetsFromProofs<C, I, A> {

	private static final SatRepairComputationSat4j_best17.Factory<?, ?, ?> FACTORY_ = new Factory<Object, Inference<?>, Object>();
	...
	private SatRepairComputationSat4j_best17(final Proof<? extends I> proof,
	...
	private class Enumerator implements MinimalSubsetEnumerator<A>, Producer<Inference<? extends Integer>> {
		...
		private SatClauseHandlerSat4j_best17<I, A> satClauseHandler_;
		...
		public void enumerate(Listener<A> listener) {
			...
			satClauseHandler_ = new SatClauseHandlerSat4j_best17<I, A>(idProvider_, infDeriv, queryId_);
	...
	private static class Factory<C, I extends Inference<? extends C>, A>
		...
		public MinimalSubsetEnumerator.Factory<C, A> create(final Proof<? extends I> proof,
			...
			return new SatRepairComputationSat4j_best17<C, I, A>(proof, justifier, monitor);
		}
