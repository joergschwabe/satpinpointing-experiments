 ...
 */
public class SatClauseHandlerRepairSat4j_miniLearningHeap<I extends Inference<?>, A> {
	...
	public SatClauseHandlerRepairSat4j_miniLearningHeap(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
