 ...
 */
public class SatClauseHandlerRepairSat4j_intuitive<I extends Inference<?>, A> {
	...
	public SatClauseHandlerRepairSat4j_intuitive(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
