 ...
 */
public class SatClauseHandlerSat4j_SAT<I extends Inference<?>, A> {
	...
	public SatClauseHandlerSat4j_SAT(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
