 ...
 */
public class SatClauseHandlerSat4j_bestWL<I extends Inference<?>, A> {
	...
	public SatClauseHandlerSat4j_bestWL(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
