 ...
 */
public class SatClauseHandlerSat4j_greedy<I extends Inference<?>, A> {
	...
	public SatClauseHandlerSat4j_greedy(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
