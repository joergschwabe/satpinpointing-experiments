 ...
 */
public class SatClauseHandlerRepairLogicNg_miniCard<I extends Inference<?>, A> {
	...
	public SatClauseHandlerRepairLogicNg_miniCard(IdProvider<A, I> idProvider,	InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, int queryId) {
		this.idProvider = idProvider;
		this.infDeriv = infDeriv;
		this.queryId = queryId;
		f = new FormulaFactory();
		p = new PropositionalParser(f);
		miniSat = MiniSat.miniCard(f);
	}
