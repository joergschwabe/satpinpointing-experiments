 ...
 */
public class SatClauseHandlerSat4j_best17<I extends Inference<?>, A> {
	...
	public SatClauseHandlerSat4j_best17(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
