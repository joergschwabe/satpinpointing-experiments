 ...
 */
public class SatClauseHandlerRepairSat4j_glucose21<I extends Inference<?>, A> {
	...
	public SatClauseHandlerRepairSat4j_glucose21(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
		this.idProvider = idProvider;
		this.infDeriv = infDeriv;
		this.queryId = queryId;
		this.solver = SolverFactory.newGlucose21();
	}
