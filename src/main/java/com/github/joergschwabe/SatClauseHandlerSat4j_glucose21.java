 ...
 */
public class SatClauseHandlerSat4j_glucose21<I extends Inference<?>, A> {
	...
	public SatClauseHandlerSat4j_glucose21(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
