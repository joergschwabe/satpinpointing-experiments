 ...
 */
public class SatClauseHandlerRepairSat4j_SAT<I extends Inference<?>, A> {
	...
	public SatClauseHandlerRepairSat4j_SAT(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
