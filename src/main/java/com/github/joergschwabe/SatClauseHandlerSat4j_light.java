 ...
 */
public class SatClauseHandlerSat4j_light<I extends Inference<?>, A> {
	...
	public SatClauseHandlerSat4j_light(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
