 ...
 */
public class SatRepairComp_Sat4j_glucose<C, I extends Inference<? extends C>, A>
		extends MinimalSubsetsFromProofs<C, I, A> {

	private static final SatRepairComp_Sat4j_glucose.Factory<?, ?, ?> FACTORY_ = new Factory<Object, Inference<?>, Object>();
	...
	private SatRepairComp_Sat4j_glucose(final Proof<? extends I> proof,
	...
	private static class Factory<C, I extends Inference<? extends C>, A>
		...
		public MinimalSubsetEnumerator.Factory<C, A> create(final Proof<? extends I> proof,
			...
			return new SatRepairComp_Sat4j_glucose<C, I, A>(proof, justifier, monitor);
		}
