 ...
 */
public class SatJustificationComp_Sat4j_light<C, I extends Inference<? extends C>, A>
		extends MinimalSubsetsFromProofs<C, I, A> {

	private static final SatJustificationComp_Sat4j_light.Factory<?, ?, ?> FACTORY_ = new Factory<Object, Inference<?>, Object>();
	...
	private SatJustificationComp_Sat4j_light(final Proof<? extends I> proof,
	...
	private static class Factory<C, I extends Inference<? extends C>, A>
		...
		public MinimalSubsetEnumerator.Factory<C, A> create(final Proof<? extends I> proof,
			...
			return new SatJustificationComp_Sat4j_light<C, I, A>(proof, justifier, monitor);
		}
