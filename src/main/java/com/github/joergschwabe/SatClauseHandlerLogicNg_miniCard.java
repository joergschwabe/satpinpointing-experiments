 ...
 */
public class SatClauseHandlerLogicNg_miniCard<I extends Inference<?>, A> {
	...
	public SatClauseHandlerLogicNg_miniCard(IdProvider<A, I> idProvider,	InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, int queryId) {
