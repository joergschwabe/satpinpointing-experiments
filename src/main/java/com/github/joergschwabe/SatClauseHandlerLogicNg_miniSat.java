 ...
 */
public class SatClauseHandlerLogicNg_miniSat<I extends Inference<?>, A> {
	...
	public SatClauseHandlerLogicNg_miniSat(IdProvider<A, I> idProvider,	InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, int queryId) {
