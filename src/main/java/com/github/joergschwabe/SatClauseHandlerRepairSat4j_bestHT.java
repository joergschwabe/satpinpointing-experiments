 ...
 */
public class SatClauseHandlerRepairSat4j_bestHT<I extends Inference<?>, A> {
	...
	public SatClauseHandlerRepairSat4j_bestHT(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
