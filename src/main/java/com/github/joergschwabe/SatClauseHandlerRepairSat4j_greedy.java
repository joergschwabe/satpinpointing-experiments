 ...
 */
public class SatClauseHandlerRepairSat4j_greedy<I extends Inference<?>, A> {
	...
	public SatClauseHandlerRepairSat4j_greedy(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
		this.idProvider = idProvider;
		this.infDeriv = infDeriv;
		this.queryId = queryId;
		this.solver = SolverFactory.newGreedySolver();
	}
