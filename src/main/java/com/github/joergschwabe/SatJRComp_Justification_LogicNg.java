 ...
 */
public class SatJRComp_Justification_LogicNg<C, I extends Inference<? extends C>, A>
		extends MinimalSubsetsFromProofs<C, I, A> {

	private static final SatJRComp_Justification_LogicNg.Factory<?, ?, ?> FACTORY_ = new Factory<Object, Inference<?>, Object>();
	...
	private SatJRComp_Justification_LogicNg(final Proof<? extends I> proof,
	...
	private static class Factory<C, I extends Inference<? extends C>, A>
		...
		public MinimalSubsetEnumerator.Factory<C, A> create(final Proof<? extends I> proof,
			...
			return new SatJRComp_Justification_LogicNg<C, I, A>(proof, justifier, monitor);
		}
