 ...
 */
public class SatJustificationComputationSat4j_miniSATHeap<C, I extends Inference<? extends C>, A>
		extends MinimalSubsetsFromProofs<C, I, A> {

	private static final SatJustificationComputationSat4j_miniSATHeap.Factory<?, ?, ?> FACTORY_ = new Factory<Object, Inference<?>, Object>();
	...
	private SatJustificationComputationSat4j_miniSATHeap(final Proof<? extends I> proof,
	...
	private class Enumerator implements MinimalSubsetEnumerator<A>, Producer<Inference<? extends Integer>> {
		...
		public void enumerate(Listener<A> listener) {
			...
			satClauseHandler_ = new SatClauseHandlerSat4j<I, A>(idProvider_, infDeriv, queryId_, SolverFactory.newMiniSATHeap());
	...
	private static class Factory<C, I extends Inference<? extends C>, A>
		...
		public MinimalSubsetEnumerator.Factory<C, A> create(final Proof<? extends I> proof,
			...
			return new SatJustificationComputationSat4j_miniSATHeap<C, I, A>(proof, justifier, monitor);
		}
