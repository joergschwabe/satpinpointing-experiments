 ...
 */
public class SatClauseHandlerRepairSat4j_miniSATHeap<I extends Inference<?>, A> {
	...
	public SatClauseHandlerRepairSat4j_miniSATHeap(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
