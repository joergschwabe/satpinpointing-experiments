...
public class SatRepairComputationSat4j_miniSATHeap<C, I extends Inference<? extends C>, A>
	...
	private class Enumerator implements MinimalSubsetEnumerator<A>, Producer<Inference<? extends Integer>> {
		...
		private SatClauseHandlerSat4j_miniSATHeap<I, A> satClauseHandler_;
		...
		public void enumerate(Listener<A> listener) {
			...
			satClauseHandler_ = new SatClauseHandlerSat4j_miniSATHeap<I, A>(idProvider_, infDeriv, queryId_);
