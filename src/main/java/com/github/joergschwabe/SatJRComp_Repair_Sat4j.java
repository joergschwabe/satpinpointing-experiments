 ...
 */
public class SatJRComp_Repair_Sat4j<C, I extends Inference<? extends C>, A>
		extends MinimalSubsetsFromProofs<C, I, A> {

	private static final SatJRComp_Repair_Sat4j.Factory<?, ?, ?> FACTORY_ = new Factory<Object, Inference<?>, Object>();
	...
	private SatJRComp_Repair_Sat4j(final Proof<? extends I> proof,
	...
	private static class Factory<C, I extends Inference<? extends C>, A>
		...
		public MinimalSubsetEnumerator.Factory<C, A> create(final Proof<? extends I> proof,
			...
			return new SatJRComp_Repair_Sat4j<C, I, A>(proof, justifier, monitor);
		}
