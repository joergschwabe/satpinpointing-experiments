 ...
 */
public class SatClauseHandlerSat4j_miniLearningHeap<I extends Inference<?>, A> {
	...
	public SatClauseHandlerSat4j_miniLearningHeap(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
