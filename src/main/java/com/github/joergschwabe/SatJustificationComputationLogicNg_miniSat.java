 ...
 */
public class SatJustificationComputationLogicNg_miniSat<C, I extends Inference<? extends C>, A>
		extends MinimalSubsetsFromProofs<C, I, A> {

	private static final SatJustificationComputationLogicNg_miniSat.Factory<?, ?, ?> FACTORY_ = new Factory<Object, Inference<?>, Object>();
	...
	private SatJustificationComputationLogicNg_miniSat(final Proof<? extends I> proof,
	...
	private static class Factory<C, I extends Inference<? extends C>, A>
		...
		public MinimalSubsetEnumerator.Factory<C, A> create(final Proof<? extends I> proof,
			...
			return new SatJustificationComputationLogicNg_miniSat<C, I, A>(proof, justifier, monitor);
		}
