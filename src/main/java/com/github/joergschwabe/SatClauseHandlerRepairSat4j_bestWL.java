 ...
 */
public class SatClauseHandlerRepairSat4j_bestWL<I extends Inference<?>, A> {
	...
	public SatClauseHandlerRepairSat4j_bestWL(IdProvider<A, I> idProvider, InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, Integer queryId) {
