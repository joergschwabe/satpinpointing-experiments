 ...
 */
public class SatClauseHandlerRepairLogicNg<I extends Inference<?>, A> {
	...
	public SatClauseHandlerRepairLogicNg(IdProvider<A, I> idProvider,	InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, int queryId) {
