 ...
 */
public class SatClauseHandlerLogicNg_glucose<I extends Inference<?>, A> {
	...
	public SatClauseHandlerLogicNg_glucose(IdProvider<A, I> idProvider,	InferenceDerivabilityChecker<Object, Inference<?>> infDeriv, int queryId) {
