...
public class SatRepair_LogicNgTest<C, I extends Inference<? extends C>, A> extends BaseEnumeratorTest<C, I, A> {
	...
	public static List<MinimalSubsetsFromProofs.Factory<?, ?, ?>> getRepairEnumeratorFactories() {
		...
		factories.add(SatRepairComp_LogicNg_miniSat.getFactory());
		return factories;
	}
