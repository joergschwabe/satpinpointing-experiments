...
import com.github.joergschwabe.SatRepairComputationPrimitive;

@RunWith(Parameterized.class)
public class SatRepairPrimitiveTest<C, I extends Inference<? extends C>, A>
	...
	public static List<MinimalSubsetsFromProofs.Factory<?, ?, ?>> getRepairEnumeratorFactories() {
		...
		factories.add(SatRepairComputationPrimitive.getFactory());
		return factories;
	}
