...
public class SatJustificationSat4jTest<C, I extends Inference<? extends C>, A> extends BaseEnumeratorTest<C, I, A> {
	...
	public static List<MinimalSubsetsFromProofs.Factory<?, ?, ?>> getJustificationEnumeratorFactories() {
		...
		factories.add(SatJustificationComputationSat4j.getFactory());
		return factories;
	}
