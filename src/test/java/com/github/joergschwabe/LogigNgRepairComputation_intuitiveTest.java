...
public class LogigNgRepairComputation_intuitiveTest<C, I extends Inference<? extends C>, A> extends BaseEnumeratorTest<C, I, A> {
	...
	public static List<MinimalSubsetsFromProofs.Factory<?, ?, ?>> getRepairEnumeratorFactories() {
		...
		factories.add(SatRepairComputationLogicNg_intuitive.getFactory());
		return factories;
	}
