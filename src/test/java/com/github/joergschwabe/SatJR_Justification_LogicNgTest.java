...
public class SatJR_Justification_LogicNgTest<C, I extends Inference<? extends C>, A> extends BaseEnumeratorTest<C, I, A> {
	...
	public static List<MinimalSubsetsFromProofs.Factory<?, ?, ?>> getRepairEnumeratorFactories() {
		...
		factories.add(SatJRComp_Justification_LogicNg.getFactory());
		return factories;
	}
