...
public class SatJustificationLogicNgTest<C, I extends Inference<? extends C>, A> extends BaseEnumeratorTest<C, I, A> {
	...
	public static List<MinimalSubsetsFromProofs.Factory<?, ?, ?>> getJustificationEnumeratorFactories() {
		...
		factories.add(SatJustificationComputationLogicNg.getFactory());
		return factories;
	}
