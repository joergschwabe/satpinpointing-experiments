...
public class SatJustificationLogicNg_intuitiveTest<C, I extends Inference<? extends C>, A> extends BaseEnumeratorTest<C, I, A> {
	...
	public static List<MinimalSubsetsFromProofs.Factory<?, ?, ?>> getRepairEnumeratorFactories() {
		...
		factories.add(SatJustificationComputationLogicNg_intuitive.getFactory());
		return factories;
	}
