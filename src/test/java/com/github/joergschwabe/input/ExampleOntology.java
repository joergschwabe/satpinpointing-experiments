...
public abstract class ExampleOntology
	...
	private static ProofAndJustifierBuilder<String, Integer> getBuilder() {
		...
		builder.conclusion("A").premise("B").premise("C").axiom(1).axiom(2).add();
		builder.conclusion("A").premise("D").axiom(3).add();
		builder.conclusion("B").axiom(1).add();
		builder.conclusion("C").add();
		builder.conclusion("D").axiom(2).add();

		return builder;
	}

	public ExampleOntology() {
		super(getBuilder());
	}
